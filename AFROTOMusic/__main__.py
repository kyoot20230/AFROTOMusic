...
async def init():
    ...
    LOGGER("ميــوزك ادمان").info("MatrixThon")
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك ادمان").info("جارِ ايقاف بوت الميوزك . . .")
