...
from AFROTOMusic.utils.database import get_loop
from AFROTOMusic.utils.decorators import AdminRightsCheck
from AFROTOMusic.utils.inline import close_markup, stream_markup
...
@app.on_message(
    command(["تخطي", "/skip", "/next", "التالي"]) & ~BANNED_USERS
)
@AdminRightsCheck
