...
from AFROTOMusic.utils.database import add_sudo, remove_sudo
from AFROTOMusic.utils.decorators.language import language
from AFROTOMusic.utils.extraction import extract_user
...
@app.on_message(command(["/delsudo", "jjjjjjjjjjjjjjjj ", "jjjjjjjjjjjjjjjjj"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(command([" ", "", ""]) & ~BANNED_USERS)
@language
