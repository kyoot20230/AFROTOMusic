...
def private_panel(_, BOT_USERNAME, OWNER: nion[bool, int] = None):
    buttons = [
        [
            InlineKeyboardButton(
    ...
    if GITHUB_REPO and OWNER:
        ...
        if OWNER:
            buttons.append(
                [
                    InlineKeyboardButton(
                        text=_["S_B_11"], url=f"https://t.me/UI_VM"
                    ),
                    InlineKeyboardButton(

                        text=_["S_B_12"], url=f"https://t.me/T_Y_E_X"
            ...
            buttons.append(
                [
                    ...
                    InlineKeyboardButton(
                        ...
                        text=_["S_B_10"], url=f"https://t.me/T_Y_E_X"
...
@app.on_message(filters.private & command("طريقة تشغيل سلمي"))
...
مطور السورس -› [Afrotoo](t.me/IIUll_l)
...
@app.on_message(filters.private & command("اوامر سلمي"))
